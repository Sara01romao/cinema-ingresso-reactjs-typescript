...
type Ticket = {
  ...
  export const TicketCart = ({ movie, movieTime, dayOfWeek, tickets, total, onRemoveTicket, handleBuyTicket }: TicketCartProps) => {
    ...
    return (
      <div className={styles.containerTicketCart}>
        ...
        <p><strong>{movie}</strong> <span> {dayOfWeek} : {movieTime}h </span></p>
        <ul>
          {tickets.length >= 1 ?  
            tickets.map((ticket) => (
